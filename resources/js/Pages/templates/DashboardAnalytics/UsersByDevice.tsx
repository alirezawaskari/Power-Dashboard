            ...
            <Col xl={4}>
                <Card className="card-height-100">
                    <Card.Header className="align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">Devices by Type</h4>
                        ...
                        <div className="table-responsive mt-3">
                            <table className="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                                <tbody className="border-0">
                                    <tr>
                                        <td><h4 className="text-truncate fs-14 fs-medium mb-0"><i className="ri-stop-fill align-middle fs-18 text-primary me-2"></i>Power Meters</h4></td>
                                        ...
                                        <td className="text-end"><p className="text-success fw-medium fs-12 mb-0"><i className="ri-arrow-up-s-fill fs-5 align-middle"></i>8 Online</p></td>
                                    </tr>
                                    <tr>
                                        <td><h4 className="text-truncate fs-14 fs-medium mb-0"><i className="ri-stop-fill align-middle fs-18 text-warning me-2"></i>Smart Plugs</h4></td>
                                        <td><p className="text-muted mb-0">
                                            <FeatherIcon
                                                icon="zap"
                                                className="me-2 icon-sm"
                                        ...
                                        <td className="text-end"><p className="text-danger fw-medium fs-12 mb-0"><i className="ri-arrow-down-s-fill fs-5 align-middle"></i>2 Offline</p></td>
                                    </tr>
                                    <tr>
                                        <td><h4 className="text-truncate fs-14 fs-medium mb-0"><i className="ri-stop-fill align-middle fs-18 text-info me-2"></i>Energy Monitors</h4></td>
                                        <td><p className="text-muted mb-0">
                                            <FeatherIcon
                                                icon="battery"
                                                className="me-2 icon-sm"
                                        ...
                                        <td className="text-end"><p className="text-warning fw-medium fs-12 mb-0"><i className="ri-arrow-up-s-fill fs-5 align-middle"></i>1 Maintenance</p></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
