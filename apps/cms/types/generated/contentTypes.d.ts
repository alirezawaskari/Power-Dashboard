...
export interface ApiApplicationSettingApplicationSetting
  ...
  info: {
    displayName: 'ApplicationSetting';
...
export interface ApiDirectoryDirectory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Parent: Schema.Attribute.Relation<'manyToOne', 'api::directory.directory'>;
...
export interface ApiFileRecordFileRecord extends Struct.CollectionTypeSchema {
  collectionName: 'file_records';
  info: {
    displayName: 'FileRecord';
    pluralName: 'file-records';
    singularName: 'file-record';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Folder: Schema.Attribute.Relation<'manyToOne', 'api::directory.directory'>;
    ...
    Type: Schema.Attribute.Enumeration<
      ['media', 'document', 'archive', 'executable', 'other']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMeterMeter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Current: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::meter.meter'> &
      Schema.Attribute.Private;
    Power: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    RecordTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Voltage: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<220>;
  };
}
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Meters: Schema.Attribute.Relation<'oneToMany', 'api::meter.meter'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    uuid: Schema.Attribute.UID<'username'> & Schema.Attribute.Required;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::file-record.file-record': ApiFileRecordFileRecord;
