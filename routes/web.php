...
use App\Http\Controllers\PowerDashboardController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->group(function () {
        Route::get('', [PowerDashboardController::class, 'userDashboard'])->name('power.user.dashboard');
        Route::get('/devices', [PowerDashboardController::class, 'userDevices'])->name('power.user.devices');
        Route::get('/alerts', [PowerDashboardController::class, 'userAlerts'])->name('power.user.alerts');
        Route::get('/support', [PowerDashboardController::class, 'userSupport'])->name('power.user.support');
        Route::get('/support/ticket-chat', [PowerDashboardController::class, 'userSupportTicketChat'])->name('power.user.support.ticket-chat');
        Route::get('/documents', [PowerDashboardController::class, 'userDocuments'])->name('power.user.documents');
        Route::get('/billing', [PowerDashboardController::class, 'userBilling'])->name('power.user.billing');
    });

    // Admin Dashboard Routes
    Route::prefix('admin')->group(function () {    
        Route::get('', [PowerDashboardController::class, 'adminDashboard'])->name('power.admin.dashboard');
        Route::get('/users', [PowerDashboardController::class, 'adminUsers'])->name('power.admin.users');
        Route::get('/users/management', [PowerDashboardController::class, 'adminUsersUserManagement'])->name('power.admin.users.management');
        Route::get('/analytics', [PowerDashboardController::class, 'adminAnalytics'])->name('power.admin.analytics');
        Route::get('/analytics/power-consumption', [PowerDashboardController::class, 'adminAnalyticsPowerConsumption'])->name('power.admin.analytics.power-consumption');
        Route::get('/analytics/energy-efficiency', [PowerDashboardController::class, 'adminAnalyticsEnergyEfficiency'])->name('power.admin.analytics.energy-efficiency');
        Route::get('/config', [PowerDashboardController::class, 'adminConfig'])->name('power.admin.config');
        Route::get('/config/system-settings', [PowerDashboardController::class, 'adminConfigSystemSettings'])->name('power.admin.config.system-settings');
        Route::get('/monitoring', [PowerDashboardController::class, 'adminMonitoring'])->name('power.admin.monitoring');
        Route::get('/monitoring/device-status', [PowerDashboardController::class, 'adminMonitoringDeviceStatus'])->name('power.admin.monitoring.device-status');
        Route::get('/monitoring/alert-logs', [PowerDashboardController::class, 'adminMonitoringAlertLogs'])->name('power.admin.monitoring.alert-logs');
        Route::get('/documents', [PowerDashboardController::class, 'adminDocuments'])->name('power.admin.documents');
    });
